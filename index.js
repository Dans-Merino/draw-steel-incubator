...
ancestry.addEventListener('change', function () {
    ...
    list = document.getElementById('benefits-list')
    list.innerHTML = ""
    for (const benefits of ancestryBenefits.full) {
        ...
        if(ancestryName === "devil"){
            ...
            document.getElementById('benefits-list').insertAdjacentHTML('afterend', '<div id="devil-features"></div>');
            // create a checkbox with the options
            const devilFeatures = document.getElementById('devil-features')
...
const benefitsByAncestry = {
    ...
    "wode elf": {
        ...
        "full": [
            {
                "short": "Otherworldly Grace: Gain an edge on resistance rolls. +1 skill from lore group",
            ...
            {
                "short": "Swift: our speed is 6.",
                "name": "Swift",
                "description": "our speed is 6."
            }
        ]
    },
    "high elf": {
